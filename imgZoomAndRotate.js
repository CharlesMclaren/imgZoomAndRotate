        ...
        imgZoomAndRotate: function (data) {
            ...
            return this.each(function (i, t) {
                ...
                $(this).click(function () {
                    ...
                    $(window.top.document).find('.backdrop').css('cssText', 'position: fixed;top: 0;right: 0;bottom: 0;left: 0;z-index: 1040;background:rgba(0,0,0,0.5);')
                    ...
                    $(window.top.document).find(".foreground .zoomImg").load(function () {
